  ...
  return (
    <div className="bg_room">
      ...
      >
        ...
        <div className="absolute w-screen h-[220px] flex place-content-center top-[22%]">
          <div className="w-[52%] avatarBox">
       
          <div className='overflow-x-scroll flex w-full h-full'>
            {vendors.map((vendor, i) => {
              return (
                <img
                  key={i}
                  src={`Avatar/vendor${vendor.img}.png`}
                  alt="Vendor icon"
        ...
        <div className="flex absolute bottom-0 justify-center items-center w-screen scale-[0.8] -my-6">
          <img src="../Market/tray_w_hand.png" width="100% " />
        </div>
        <div className="flex  vegeCardDiv mt-44  ">
          {cards.map((card, i) => (
            <div
              className="flex -mx-8 flex-col scale-[0.5] place-content-evenly items-center"
              key={i}
            >
              <div
              ...
              <div className="text-white w-24 mt-20 py-1 cardNoGodown text-center rounded-lg text-[32px]">
                {card.cardCount}
              </div>
            </div>
          ))}
        ...
        <div
          ...
          className={`${isModal ? "hidden" : "block"} bag`}
          id="bagIcon"
        >
          <span className="bg-[#F30002] ml-10 mt-2 text-xl text-white rounded-full text-center h-8 w-8 absolute">
            1
          </span>
          <img
            src="../Icons/bag.png"
        ...
        <div id="bagContent" className={isModal ? "block" : "hidden"}>
          <div className="bagOnClick text-center">
            <button
              onClick={() => setIsModal(!isModal)}
              className="text-center bag_click"
            >
              <svg
                className="ml-8"
                width="23"
            ...
            <ul>
              <li>
                <button>
                  <img
                    className="bag_icons mx-auto nb"
                    src="../Icons/book.png"
                    width="80%"
                  />
